...
const HomePage = () => {
  return (
    <div className="font-sans mt-20 mb-[15vh] bg-[#FDF7EF] text-gray-800">
      ...
      <section className="bg-[#D0E7F5] w-[90%] md:w-[70%] lg:w-[30%] mx-auto rounded-[10px] border-3 border-[#0A1D35] py-4 px-6 md:px-20 text-center">
        <div className="flex">
          <img
